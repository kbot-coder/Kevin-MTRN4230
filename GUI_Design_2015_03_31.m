...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_Design_2015_03_31_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Design_2015_03_31_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_Design_2015_03_31 is made visible.
function GUI_Design_2015_03_31_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_Design_2015_03_31 (see VARARGIN)

% Choose default command line output for GUI_Design_2015_03_31
handles.output = hObject;

% CREATE TIMER HANDLES TO CONTROL SNAPSHOT CAMERA
handles.mycam=webcam;
handles.timer = timer(...
    'ExecutionMode', 'fixedRate', ...       % Run timer repeatedly
    'Period', 0.01, ...                        % Initial period is 1 sec.
    'TimerFcn', {@update_display,hObject,handles}); % Specify callback function
%---------------------------------------------------
...
global imgConv imgTable captConv captTable
captConv = 0;
captTable = 0;
guidata(hObject, handles);

% UIWAIT makes GUI_Design_2015_03_31 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_Design_2015_03_31_OutputFcn(hObject, eventdata, handles) 
...
% hObject    handle to Input_Joint_3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to ConvCam (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% hObject    handle to CmdStatus (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to GoByEndEffector (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set ( handles.CmdStatus, 'String' , 'Start Showing Video From Camera Input' ) ;
start(handles.timer);
...
% hObject    handle to ImCapt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set ( handles.CmdStatus, 'String' , 'Capture Image From Camera Input & Store it in Folder' ) ;

global imgConv imgTable captConv captTable
captConv =captConv +1;
captTable = captTable+1;
imwrite(imgConv,['Conveyor/image' num2str(captConv) '.jpg']);
imwrite(imgTable,['Table/image' num2str(captTable) '.jpg']);
